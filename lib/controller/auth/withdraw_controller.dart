  ...
  void withdraw() async {
    ...
    if (formdata!.validate()) {
      ...
      if (response['complete'] == true) {
        ...
        Get.snackbar('ملاحظة هامة', 'يجب عليك الانتظار الى 24ساعة على الاقل ليتم تحويل الارباح اليومية الى الرصيدالمتوفر'); 
        print('not Valid');
      }
     print(' Valid');
    } else {
      // ignore:
        print('not Valid');
      Get.snackbar('يجب عليك التأكد ',' من اسم المستخدم او كلمة السر',
       );
    }
