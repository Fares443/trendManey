...
class _ManyState extends State<Many> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text( "عملية السحب",style: TextStyle(color: AppColor.primaryColor,fontSize: 28,fontWeight: FontWeight.bold)),
        leading: IconButton(
          onPressed: () {
        ...
        child: Form(
          ...
          child: ListView(children: [
            ...
            const CustomTextBodyAuth(
                text: "\n ملاحظه هامة\n قبل عملية السحب عليك التاكد ان يكون الرقم الموبيل عند تسجيل الدخول هو نفس الرقم عند عملية السحب "),
